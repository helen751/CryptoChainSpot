...
<div class="horizontal-menu">
      <nav class="navbar top-navbar col-lg-12 col-12 p-0"  style="background-color: darkblue;">
        <div class="container">
      ...
      <nav class="bottom-navbar">
        <div class="container">
          <ul class="nav page-navigation">
            ...
            <li class="nav-item"  onclick="showaddnews();" style="cursor: pointer;">
            ...
            <li class="nav-item">
              ...
              <div class="submenu">
                <ul class="submenu-item">
                <li class="nav-item"><a class="nav-link" href="profile">All Withdrawals</a></li>
                <li class="nav-item"><a class="nav-link" href="wallet">Pending Withdrawals</a></li>
