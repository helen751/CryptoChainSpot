 ...
 ?> 
    ...
    <footer class="footer">
          <div class="w-100 clearfix">
            <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © 2019<?php //date('Y'); ?><a href="index.php" >CryptochainSpot</a>. All rights reserved.</span>
