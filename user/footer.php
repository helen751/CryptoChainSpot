<footer class="footer">
          <div class="w-100 clearfix">
            <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © 2019<?php //echo date('Y'); ?> <a href="index" >CryptoChainSpot</a>. All rights reserved.</span>
