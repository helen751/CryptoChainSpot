...
<footer class="footer" id="footer">
         <div class="footer-top">
            <div class="container"  style="background-color: goldenrod;">
               <div class="footer-top-bg row"  style="background-color: goldenrod;">
                  ...
                  <!-- Box 2 end-->
                  <div class="col-md-4 footer-box"><i class="icon icon-upload"></i>
                     <div class="footer-box-content">
                        <h3>USD 5.6 M</h3>
                        <p>WITHDRAWALS</p>
                     </div>
                  ...
                  <div class="col-md-4 footer-box"><i class="icon icon-download"></i>
                     <div class="footer-box-content">
                        <h3>USD 6.9 M</h3>
                        <p>DEPOSITS</p>
                     </div>
         ...
         <div class="footer-main bg-overlay">
            <div class="container">
               <div class="row">
                  <div class="col-lg-7 col-md-12 footer-widget footer-about">
                     <div class="footer-logo">
                        <img src="img/logo.png" alt="" style="width: auto; height: 35px;">
                     </div>
                     <p>As a global investment manager and fiduciary to our clients, our purpose at Cryptochainspot is to help everyone experience financial well-being.
                     Cryptochainspot products lead the industry in terms of availability and scale, both in investment opportunities and liquidity.</p>
                ...
                <!-- <div class="row"> -->
                  ...
                  <!-- <div class="col-lg-12 footer-widget">
                     ...
                     <div class="newsletter-introtext">
                         ...
                         certain investors due to regulatory or other constraints either in Switzerland, the United States or elsewhere.
                         ...
                         Digital Stakers strongly suggests that you seek the advice of an independent financial advisor in this regard.
                     </div>
         ...
         <!-- Footer Main-->
         <div class="copyright" style="background-color: goldenrod;">
            <div class="container" style="background-color: goldenrod;">
...
<!-- Mirrored from digitalstakers.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 16 Feb 2022 08:30:30 GMT -->
</html>
